...
s1 = "Counties with population declines will be Vermillion, Posey and Madison."
s2 = "Vermillion, Posey and Madison County populations will decline."
print(semanticSimilarity(s1, s2))